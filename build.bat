@echo off
REM Build script for Windows - 9:make_build
...
g++ -std=c++17 -Iinclude -I"SDL/x86_64-w64-mingw32/include" src/main.cpp src/Engine.cpp src/Renderer.cpp src/InputManager.cpp src/AudioManager.cpp src/AssetManager.cpp src/Scene.cpp src/Physics.cpp -o 9Gravity.exe -L"SDL/x86_64-w64-mingw32/lib" -lSDL3
...
goto end
REM SDL3 is included in the project - no additional installation needed!
...
REM Default: try CMake first, fallback to Make
...
if %errorlevel% neq 0 (
    ...
    echo - MSYS2/MinGW-w64 with make
    echo - Or use cmake build: build.bat cmake
    goto error_end
)
make
if %errorlevel% equ 0 (
    ...
    echo Please ensure you have MinGW-w64 or Visual Studio installed.
    echo SDL3 libraries are included in the project.
    goto error_end
)
goto end
